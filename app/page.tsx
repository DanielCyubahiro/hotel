...
const galleryImages = [
  ...
  { src: "https://placehold.co/600x400/f0e6a8/ffffff?text=Private+Bedroom", alt: "A cozy and well-lit private bedroom" },
  { src: "https://placehold.co/600x400/d1a3a3/ffffff?text=Building+Exterior", alt: "Exterior view of the historic hotel building" },
        ...
        <section id="home" className="w-full bg-gray-100 dark:bg-gray-800 py-20 md:py-32">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300">
              Discover a unique, family-like community in a historic hotel. Private rooms with all-inclusive bills, perfect for students and academics.
            </p>
              ...
              <div className="md:col-span-2">
                <Card className="sticky top-24">
                  ...
                  <CardContent>
                    ...
                    <p className="mt-4">
                      Our rate includes <strong>all bills</strong>. We also assist with official contract registration to make your transition to Turin as smooth as possible.
                    </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="prose prose-lg dark:prose-invert">
                ...
                <p className={"text-lg"}>
                  Welcome! We are <strong>Martin and Katherine Spadaro</strong>, your hosts. Our guest house is an elegant old hotel within walking distance of the centre of Turin. <br/>We foster a friendly family like environment, where each room is private, with a private bathroom, and common facilities including a large kitchen, lounge,  dining area and a beautiful landscaped garden. There are 14 bedrooms, but only 10 are used for residents.
                  <br/>We are in safe part of town, and the house has constant support from us. <br/><strong>If you are a student, academic assistance may be available.</strong>
                </p>
              </div>
            </div>
          </div>
